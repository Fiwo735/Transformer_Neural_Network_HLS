...
void self_attention(
    ...
    nnet::normalize<data_T, data_T, CONFIG_T>(data, input_norm, norm_weight, norm_bias);
    fout << "input_norm:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_in>(input_norm, fout);
    
    // 2.1 qkv (dense)
    data_T qkv_out[CONFIG_T::n_qkv];
    data_T zero_bias0[CONFIG_T::n_qkv];
    nnet::dense<data_T, data_T, CONFIG_T>(input_norm, qkv_out, QKV_weight, zero_bias0);
    fout << "qkv_out:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_qkv>(qkv_out, fout);
    ...
    fout << "qkv_reshaped:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_qkv>(qkv_reshaped, fout);
    ...
    nnet::dense<data_T, data_T, CONFIG_T>(queries, energy, keys, zero_bias1);
    fout << "energy:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_energy>(energy, fout);
    ...
    fout << "energy_scaled:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_energy>(energy_scaled, fout);

    // 5 attention - softmax
    data_T attention[CONFIG_T::n_energy];
    nnet::softmax<data_T, data_T, CONFIG_T>(energy_scaled, attention); // softmax
    fout << "attention:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_energy>(attention, fout);

    // 6 scaled attention - dense
    data_T scaled_attention[CONFIG_T::n_scaled_attention];
    data_T zero_bias2[CONFIG_T::n_scaled_attention];
    nnet::dense<data_T, data_T, CONFIG_T>(attention, scaled_attention, values, zero_bias2);
    fout << "scaled_attention:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_scaled_attention>(scaled_attention, fout);
    ...
    fout << "scaled_attention_reshaped:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_scaled_attention>(scaled_attention_reshaped, fout);

    // 8 dense
    data_T result[CONFIG_T::n_out];
    nnet::dense<data_T, data_T, CONFIG_T>(scaled_attention_reshaped, result, dense_weight, dense_bias);
    fout << "result:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_out>(result, fout);
    ...
    fout << "sum_out:" << "\n";
    nnet::print_result<input_t, CONFIG_T::n_out>(sum_out, fout);
