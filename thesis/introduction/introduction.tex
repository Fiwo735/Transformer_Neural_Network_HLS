...
The novel aspects proposed in this work can be summarized as follows, with the first two addressing challenge \textbf{C1}, and the latter challenge \textbf{C2}:
