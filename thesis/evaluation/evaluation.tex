...
\indo{area under curve, confusion matrix (true false positive nagative)}
\indo{shorten pareto and roofline and maybe more coz theyre explained in background now}
