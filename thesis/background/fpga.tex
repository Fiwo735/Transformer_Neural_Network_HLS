...
\begin{itemize}
  \item \textbf{Block Random Access Memory (BRAM)} - \indo{finish}
  \item \textbf{Digital Signal Processing (DSP) logic element} - \indo{finish}
  \item \textbf{Flip-Flop (FF)} - \indo{finish}
  \item \textbf{Lookup Table (LUT)} - \indo{finish}
\end{itemize}
