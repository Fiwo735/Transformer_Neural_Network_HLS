...
\subsection{Latency, throughput, and hardware resource utilization}
...
\todofig{serial + parallel + pipeline blocks }
...
\todofig{pareto front with a missing area highlighting it should be explored as there are likely interesting designs there}
