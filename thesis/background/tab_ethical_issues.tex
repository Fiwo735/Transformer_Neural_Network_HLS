\begin{table}[hpt]
  ...
  \multirow{-3}{*}{\cellcolor[HTML]{ECF4FF}\begin{tabular}[c]{@{}l@{}}Developing\\ countries\end{tabular}} & putting the individuals taking part in the project at risk                                 & No                                                   \\ \hline
                                                                                                           & {\color[HTML]{FF0000}elements that may cause harm to the environment, animals or plants}   & {\color[HTML]{FF0000}Yes (B)}                        \\ \cline{2-3} 
  \multirow{-2}{*}{Environment}                                                                            & \cellcolor[HTML]{ECF4FF}elements that may cause harm to humans                             & \cellcolor[HTML]{ECF4FF}No                           \\ \hline
