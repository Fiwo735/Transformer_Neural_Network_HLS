...
void layer_normalize(
    ...
    std::cout << "L5, var=" << var << "/CONFIG_T::n_in=" << CONFIG_T::n_in << std::endl;
    var /= (CONFIG_T::n_in);
    // fout << "variance: " << var << " "; 
    ...
    var += eps;
    std::cout << "L6, var=" << var << std::endl;
    // std::cout << "var: " << var << std::endl;
    float float_var = (float) var;
    std::cout << "L7, float_var=" << float_var << std::endl;
    data_T denominator = (data_T) std::sqrt(float_var);
    // fout << "denominator: " << denominator << "\n"; 

    std::cout << "L8, denominator=" << denominator << std::endl;
