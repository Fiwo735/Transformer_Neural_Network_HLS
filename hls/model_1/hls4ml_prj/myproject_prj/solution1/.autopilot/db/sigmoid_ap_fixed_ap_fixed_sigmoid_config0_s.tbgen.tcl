set moduleName sigmoid_ap_fixed_ap_fixed_sigmoid_config0_s
set isTopModule 0
...
set C_modelName {sigmoid<ap_fixed,ap_fixed,sigmoid_config0>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 35 regular {array 32 { 1 1 } 1 1 }  }
	{ data_V_offset int 2 regular  }
	{ res_V int 20 regular {array 16 { 0 0 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sigmoid_table11_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	res_V { ap_memory {  { res_V_address0 mem_address 1 4 }  { res_V_ce0 mem_ce 1 1 }  { res_V_we0 mem_we 1 1 }  { res_V_d0 mem_din 1 20 }  { res_V_address1 MemPortADDR2 1 4 }  { res_V_ce1 MemPortCE2 1 1 }  { res_V_we1 MemPortWE2 1 1 }  { res_V_d1 MemPortDIN2 1 20 } } }
}
set moduleName sigmoid_ap_fixed_ap_fixed_sigmoid_config0_s
set isTopModule 0
set isTaskLevelControl 1
