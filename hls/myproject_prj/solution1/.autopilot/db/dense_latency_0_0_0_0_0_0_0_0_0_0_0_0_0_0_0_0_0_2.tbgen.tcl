...
set C_modelArgList {
	{ data_V_read int 560 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_V_read", "interface" : "wire", "bitwidth" : 560, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_V_read sc_in sc_lv 560 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":560, "type": "signal", "bundle":{"name": "data_V_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	data_V_read { ap_none {  { data_V_read in_data 0 560 } } }
}
